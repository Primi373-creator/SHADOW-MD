...
cmd({
    ...
    async(Void, citel) => {
        let { data } = await axios.get('https://api.github.com/repos/Cipher/SHADOW-MD')
        let cap = `
*⭐ Total Stars:* ${data.stargazers_count} stars
*🍽️ Forks:* ${data.forks_count} forks
*🍁 Repo:* _https://github.com/Cipher0071/SHADOW-MD_
*🧩 Scan:* _https://github.com/Cipher0071/SHADOW-MD_
\n*Visit For Tutorial :-*
 _https://www.Youtube.com/c/Cipher0071_
\n\n${Config.caption}`
...
cmd({
        pattern: "link",
        alias: ["ytube", "yt", "myyt"],
        desc: "Sends info about My Ytube Channel __CheckOut :_ www.Youtube.com/c/Cipher0071",
        category: "general",
        filename: __filename,
    },
    async(Void, citel) => {
...
*🍽️ Total Subscriber:* 0 Subscribers
*🍁 Channel Link:* _https://youtube.com/@Cipher0072?sub_confirmation=1_\n
╭━━━━━━━━━━━━━━━━━━━━╮
┇  ╔═╦╗╔╦╗╔═╦═╦╦╦╦╗╔═╗
┇  ║╚╣║║║╚╣╚╣╔╣╔╣║╚╣═╣
┇  ╠╗║╚╝║║╠╗║╚╣║║║║║═╣
...
*🌟Description:* A WhatsApp bot with rich features, Created By *Cipher*.\n
*⚡Speed:* ${latensie.toFixed(4)} ms
*⌛Uptime:* ${runtime(process.uptime())}
*🕸Version:* 1.0.0
*👤Owner:*  ${Config.ownername}\n\n
*Powered by 'SHADOW-MD'*
*Youtube :* _youtube.com/c/Cipher0071_
\n\n${Config.caption}`;
        let buttonMessaged = {
            image: { url: await botpic() },
            caption: ter,
