...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            var role = "GOD✨";
            if (lvpoints <= 2) { var role = "🌟 Novice"; } 
else if (lvpoints <= 4) { var role = "⚔️Apprentice"; } 
else if (lvpoints <= 6) { var role = "🔮Mage"; } 
else if (lvpoints <= 8) { var role = "🌪️Shinobi"; } 
else if (lvpoints <= 10) { var role = "🚀Pilot"; } 
else if (lvpoints <= 12) { var role = "🌌Space Explorer"; } 
else if (lvpoints <= 14) { var role = "👹Yokai Slayer"; } 
else if (lvpoints <= 16) { var role = "⚡Electric Knight"; } 
else if (lvpoints <= 18) { var role = "🌊Water Bender"; } 
else if (lvpoints <= 20) { var role = "🔥Fire Sorcerer"; } 
else if (lvpoints <= 22) { var role = "🛡️Guardian"; } 
else if (lvpoints <= 24) { var role = "🎭Phantom Thief"; } 
else if (lvpoints <= 26) { var role = "🤖Mecha Pilot"; } 
else if (lvpoints <= 28) { var role = "👑Monarch"; } 
else if (lvpoints <= 30) { var role = "🌈Magical Girl/Boy"; } 
else if (lvpoints <= 32) { var role = "🌟Cosmic Hero"; } 
else if (lvpoints <= 34) { var role = "Eta🌗💻"; } 
else if (lvpoints <= 36) { var role = "Zeta🌖🧠"; } 
else if (lvpoints <= 38) { var role = "Epsilon🌕🔮"; } 
else if (lvpoints <= 40) { var role = "Delta🌔⚔️"; } 
else if (lvpoints <= 42) { var role = "Gamma🌓🕵️‍♂️"; } 
else if (lvpoints <= 44) { var role = "Beta🌒🔍"; } 
else if (lvpoints <= 46) { var role = "Alpha🌑👑"; } 
else if (lvpoints <= 55) { var role = "SHADOW🌑👤"; }
