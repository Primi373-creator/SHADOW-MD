...
try {
    ...
    console.log("🌍 Connected to the  SHADOW-MD DB")
} catch {
...
let cc= Config.sessionName.replace(/SHADOW;;;/g, "");
var suhails = false;
...
setTimeout(() => {
    ...
    async function syncdb() {
        ...
        const Void = VoidConnect({
            ...
            browser: ['SHADOW-MD', 'safari', '1.0.0'],
...
*/ //------------------------------------------------------------------------------------
                    ...
                    if (checkinfo) {
                        ...
                        catch(e){console.log(`IsSuhail : ${suhails} \nGroup Id : ${anu.id}\nerror Returning in SHADOW-Md Group : ` , e)}
